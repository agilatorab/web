...
export default [
  ...
  {
    // Node tooling scripts (brand generation, SEO checks, release scripts) and
    // agent-skill helpers. These run under Node, so expose its globals rather
    // than the browser's.
    files: ["scripts/**/*.mjs", "lib/**/*.mjs", ".agents/skills/**/*.mjs"],
    languageOptions: {
      sourceType: "module",
      ecmaVersion: 2022,
